...
|-|-|
|이름|한승현|
|이메일|hsh201008@naver.com|
|깃허브주소|https://github.com/HSH703/Seunghyun_Portfolio.git|
|포트폴리오|다양한 프로젝트를 수행하며 단순히 기능을 구현하는 수준을 넘어, 문제를 분석하고 개선점을 도출하며 더 나은 결과물을 만들어내는 과정에서 성장해왔습니다.
...
| Version | 핵심 목표 |주요기능|
|---|---|---|
| v4(최종) | 사용자 중심 UI/UX 개편으로 콘텐츠 탐색 효율/참여도를 높여 경쟁력 강화 | React 전환 + JWT/Redis/CI-CD 적용으로 운영형 아키텍처 완성 | 
